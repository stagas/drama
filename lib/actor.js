...
Actor.prototype.processNext = function (message) {
  ...
  context.send = this.self.send.bind(this.self)
  context.tell = this.self.tell.bind(this.self)
  context.ask = this.self.ask.bind(this.self)
  context.stop = this.self.stop.bind(this.self)
  context.reply = function () {
    var args = [].slice.call(arguments)
    args.unshift('__reply__')
    this.self.send.apply(this.self, args).to(this.sender)
  }.bind(context)
